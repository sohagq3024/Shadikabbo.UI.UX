              ...
              >
                ...
                {isCommentsOpen && (
                  <div className="bg-slate-50/60 p-3 sm:p-4 space-y-3 animate-in fade-in">
                    ...
                    {/* Write comment input or Guest prompt */}
                    {currentUser ? (
                      <div className="flex items-center gap-2 pt-1">
                        ...
                        <div className="flex-1 relative flex items-center">
                          ...
                          <button
                            ...
                            className="absolute right-2 p-1 text-[#D91B2B] hover:text-[#b81423] cursor-pointer transition-colors"
                            title="Post comment"
                          >
                            <Send className="w-3.5 h-3.5" />
                          </button>
                      ...
                      <div className="flex items-center justify-between p-2.5 rounded-xl bg-slate-100/90 border border-slate-200/80 text-xs">
                        <span className="text-slate-600 font-medium text-[11.5px]">
                          Log in to like and leave comments on reviews
                        </span>
                        <button
                          type="button"
                          onClick={onOpenLogin}
                          className="px-3 py-1 bg-[#16205B] hover:bg-[#0f1744] text-white rounded-lg text-xs font-semibold shadow-2xs transition-colors cursor-pointer"
                        >
                          Log In
                        </button>
                      </div>
