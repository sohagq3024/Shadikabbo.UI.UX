  ...
  return (
    <section
      ...
      className={`relative overflow-hidden bg-gradient-to-br from-[#02061f] via-[#000080]/90 to-[#040827] text-white ${
        isHomePage ? 'pt-2 pb-5 sm:pt-3 sm:pb-7' : 'py-8 sm:py-12'
      ...
      <div className="relative max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        <div className={`flex items-center justify-between ${isHomePage ? 'mb-2 sm:mb-3.5' : 'mb-6 sm:mb-8'} gap-2`}>
          ...
          {isHomePage && onViewMore ? (
            <button
              onClick={onViewMore}
              className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 sm:px-5 sm:py-2 rounded-xl bg-gradient-to-r from-[#D91B2B] to-[#b91422] hover:brightness-110 text-white text-xs sm:text-sm font-bold shadow-md shadow-rose-900/30 transition-all group shrink-0"
            >
              <span>See More</span>
